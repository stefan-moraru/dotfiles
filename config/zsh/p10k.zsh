# Generated by Powerlevel10k configuration wizard on 2024-06-27 at 13:15 EEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    function git_current_user_email_scoped() {
      ...
      if [[ -n $git_email ]]; then
        local domain="@${git_email#*@}"
        echo "($domain) "
      fi
    }

    res+=" ${modified}$(git_current_user_email_scoped)"
